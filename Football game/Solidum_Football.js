...
var player1ScoreColor = "#FF6EC7";
var player2ScoreColor = "red";
...
function start() {
    ...
    out.innerHTML = "<span style='color:" + player1ScoreColor + "'>Player 1 Score: " + player1.score + "</span><br><span style='color:" + player2ScoreColor + "'>Player 2 Score: " + player2.score + "</span>";
...
function renderPlayers() {
    ...
    player1Image.src = 'Bocchi.PNG'; 
    c.drawImage(player1Image, player1.x - player1.size, player1.y - player1.size, player1.size * 2, player1.size * 2);
  
    
    var player2Image = new Image();
    player2Image.src = 'Kita.png'; 
    c.drawImage(player2Image, player2.x - player2.size, player2.y - player2.size, player2.size * 2, player2.size * 2);
